...
<html>
    ...
    <head>
        ...
        <!-- SPECIFIC CSS -->
        <link href="{{ asset('fron/css/tour.css') }}" rel="stylesheet">
        ...
        <!-- Modernizr -->
        <script src="{{ asset('fron/js/modernizr_tour.js') }}"></script>
    ...
    <body>
        ...
        <section class="tour-section">
            <div class="full-container">
                <h1 id="intro_txt">Selamat Datang di MIC<span>Sekolah Tinggi Manajemen Informatika dan Komputer</span>
                </h1>
            </div>
            ...
            <div class="full-container">
                ...
                <div class="half-container">
                    <div class="txt_container">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores eos labore ratione illum
                            excepturi neque sunt blanditiis ducimus soluta quae!</p>
        ...
        <nav>
            <ul class="top-nav">
                <li><a href="{{ route('welcome') }}" class="back"><i class="arrow_back"></i></a></li>
            </ul>
        </nav> <!-- End top-nav-->
        ...
        <!-- Specific scripts -->
        <script src="{{ asset('fron/js/tour.min.js') }}"></script>
